...
for i, neuron in enumerate(neurons):
    ...
    if (sparse): # SGPT
        train_out, train_out_xx, train_out_tt, xt_len, ALPHA, Lhat = gram_schmidt1(PINN, i, xt_resid, 
         out_full, out_xx_full, out_yy_full, X_umax_idx, X_all_idx, X_train_all, xt_test, out_test)
