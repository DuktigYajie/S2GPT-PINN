...
# Modules
from AC_precompute import inputs, gram_schmidt1, gram_schmidt2
from tensorflow.keras.models import Sequential
from AC_test import gpt_test, gpt_test_loss
from AC_GPT_train import offline_generation
...
data = scipy.io.loadmat('E:\Research\Work_with_Chen\My_third_work\SGPT\SGPT-PINN Code\Allen Cahn\AC.mat')
...
for i, neuron in enumerate(neurons):
    ...
    if (sparse): # SGPT
        ...
        train_out_BC_lb_x, train_out_BC_diff_x = gram_schmidt1(PINN, i, xt_resid, 
    ...
    if (sparse):
        ...
        gram_schmidt2(i, xt_resid, lmbda, eps, trained_c, residual_full, out_full, 
